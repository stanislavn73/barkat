        ...
        return (
            <FullPage min ref={this.block} className='soft-block-wrapper'>
                <Padded className='soft-block-padded'>
                    ...
                    <PlainText className='soft-plain-text'>
                        3DEXPERIENCE – это цифровая среда для моделирования предметов окружающего мира и
                        связанных с ними ощущений, которая обеспечивает эффективную работу производственных
                        процессов и позволяет увидеть жизненный цикл изделия от этапа его создания до утилизации
                        в виртуальной реальности.
                    </PlainText>
                    <PlainText className='soft-plain-text'>
                        Dassault Systèmes, штаб квартира которой расположена во французском Велизи (пригород Парижа),
                        является одним из лидеров мирового рынка PLM и САПР, насчитывает 64 центра разработок,
                        представлена в 140 странах, обеспечивает поддержку более 250 тыс. корпоративных клиентов
                        в 11 промышленных отраслях.
                    </PlainText>
                    <PlainText className='soft-plain-text'>
