        ...
        <FullPage min className={styles['soft-block-wrapper']}>
            <Padded className={styles['soft-block-padded']}>
                ...
                <PlainText className={styles['soft-plain-text']}>
                    ...
                    программного обеспечения в области 3D-проектирования и BIM
                    для промышленного и гражданского строительства,
                    машиностроения, рынка средств информации и развлечений.
                </PlainText>
                <PlainText className={styles['soft-plain-text']}>
                    Компанией разработан широкий спектр программных продуктов
                    для архитекторов, инженеров, конструкторов, самые популярные
                    из которых: Revit, AutoCAD, AutoCAD LT, Inventor
                    Professional, AutoCAD Civil 3D, 3ds Max. Сейчас
                    насчитывается более 10 млн пользователей Autodesk по всему
                    миру, которые используют данное программное обеспечение,
                    чтобы сэкономить время и деньги, получить конкурентные
                    преимущества и изменить способ воплощения идей в жизнь.
                    Пользователи не просто видят модель на экране, но и могут
                    испытать ее. Благодаря этому экономятся время и средства,
                    повышается качество и рождаются новаторские решения.
                </PlainText>
                <PlainText className={styles['soft-plain-text']}>
