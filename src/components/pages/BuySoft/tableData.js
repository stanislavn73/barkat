...
export const rows = [
  ...
  createData('V-Ray (Интеративный метод)', closeMark, closeMark, closeMark, checkMark, checkMark),
  createData('Scan Essentials (работа с облаками точек)', closeMark, closeMark, closeMark, checkMark, checkMark),
  createData('Scan Essentials (профессиональная документация)', closeMark, closeMark, closeMark, checkMark, checkMark),
