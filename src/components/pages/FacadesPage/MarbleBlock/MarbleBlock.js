...
export default function MarbleBlock() {
  return (
    <div className='facades-sixth-block facade-type-wrapper'>
      <FullPage>
        <Title>
          Фасад МРАМОР / ДОЛОМИТ / ТРАВЕРТИН
        </Title>
        <ImageSlides data={facadesMarbleSlides} />
      </FullPage>
      <Padded>
        <SubTitle>
          Юрский мрамор как строительный материал
      </SubTitle>
        <p>
          В последние годы фасадные панели из натурального мрамора стали
          одними из наших самых востребованных продуктов. Вентилируемый
          фасад из мрамора способен качественно преобразить любой объект
          как коммерческого, так и гражданского строительства. Исторически
          мрамор юрского периода добывался и использовался в качестве
          строительного материала еще со времен Римской империи. Долгую
          историю успеха натурального камня демонстрируют сегодня остатки
          стен, башен и бань, которые до сих пор можно найти во многих
          уголках Европы. Различные находки из недавнего прошлого, такие
          как Römertherme или Römerkastell в Вайсенбурге, ясно показывают
          это.
        </p>
        <SubTitle>
        ...
        <div className='mable-horizontal-wrapper'>
          ...
          <div>
            <div className='marble-image-item'>
              <DownloadCatalog className='marble-download-catalog' file={catalog} name='Каталог Мрамор / Доломит / Травертин' />
            </div>
          </div>
        </div>
        <SubTitle>
          Металлическая подсистема навесного вентилируемого фасада под облицовку
          мраморными плитами с пропилом, устанавливаемая скрытым способом на
          кляммерных планках
        </SubTitle>
        <div className='marble-system-wrapper facades-system-wrapper'>
          ...
          <div>
            <p>
              ...
              <p>• Мраморные облицовочные плиты с пропилом крепятся к подсистеме при помощи кляммерных планок</p>
              <p>• Крепление кляммерных планок к несущим профилям осуществляется при помощи алюминиевых заклепок</p>
              <p>• Несущие профили крепятся с помощью кронштейнов либо к плоскости стены (для рядовой подсистемы) либо к плитам перекрытия (для межэтажной подсистемы) </p>
            </p>
            <p>
              <SubTitle>
                Преимущества:
